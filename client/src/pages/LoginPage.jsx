  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <form onSubmit={onSubmit} className="glass-card w-full max-w-md rounded-2xl p-6 shadow-card">
        <h1 className="section-title text-3xl font-bold">Welcome Back</h1>
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Login to continue your mock interviews.</p>
        ...
        <p className="mt-4 text-center text-sm text-slate-600 dark:text-slate-300">
          New user?{" "}
          <Link to="/signup" className="font-semibold text-brand-700 dark:text-brand-300">
            Create account
          </Link>
        </p>
      </form>
